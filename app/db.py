...
class User(Base):
    ...
    username = Column(String, unique=True, index=True) # for users it is wechat openid, otherwise 'bot'
...
class Message(Base):
    ...
    media_id = Column(String) # used by wechat for voice/img/video messages
